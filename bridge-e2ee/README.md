...
> Python applications should use `await listeningE2EEEvent.connect_mqtt()` and the suffix-free async methods in `BridgeActions`. Direct stdin/stdout examples below document the wire protocol, not the recommended application API.
