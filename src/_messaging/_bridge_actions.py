...
class BridgeActions:
    ...
    async def _call_async(self, method: str, params: dict[str, Any]) -> dict[str, Any]:
        return await self._bridge.call_async(method, params)

    def edit_message(self, message_id: str, new_text: str) -> dict[str, Any]:
        return self._call("editMessage", {"messageId": message_id, "newText": new_text})
    ...
    def unsend_message(self, message_id: str) -> dict[str, Any]:
        return self._call("unsendMessage", {"messageId": message_id})

    async def unsend_message_async(self, message_id: str) -> dict[str, Any]:
        return await self._call_async("unsendMessage", {"messageId": message_id})
    ...
    async def edit_e2ee_message_async(
        self, chat_jid: str, message_id: str, new_text: str
    ) -> dict[str, Any]:
        return await self._call_async(
            "editE2EEMessage",
    ...
    async def unsend_e2ee_message_async(
    ...
    async def send_typing_indicator_async(
        self,
        thread_id: int,
        is_typing: bool,
        is_group: bool = False,
    ...
    async def send_e2ee_typing_async(
    ...
    async def send_e2ee_audio_async(
        self,
        chat_jid: str,
        data: bytes,
        mime_type: str = "audio/ogg; codecs=opus",
    ...
    async def send_e2ee_image_async(
        self,
        chat_jid: str,
        data: bytes,
        mime_type: str = "image/jpeg",
    ...
    def download_media(self, url: str) -> bytes:
        result = self._call("downloadMedia", {"url": url})
        return base64.b64decode(result["data"], validate=True)

    async def download_media_async(self, url: str) -> bytes:
        result = await self._call_async("downloadMedia", {"url": url})
        return base64.b64decode(result["data"], validate=True)
    ...
    async def download_e2ee_media_async(
        self,
        direct_path: str,
        media_key: str,
        media_sha256: str,
