...
1. **Reuse** (khuyến nghị) — nhanh, không phải pair lại::
       ...
       from fbchat_v2 import listeningE2EEEvent, sendingE2EEEvent
...
2. **Standalone** — tự spawn bridge, tự ``connect()``::

       sender = sendingE2EEEvent(dataFB=dataFB, log_level="warn")
...
# ---------------------------------------------------------------------------
# Re-export with a name symmetric to listeningE2EEEvent
# ---------------------------------------------------------------------------

#: Alias public — dùng ngoài: ``from fbchat_v2 import sendingE2EEEvent``.
sendingE2EEEvent = api
