...
from fbchat_v2._core._utils import formAll, mainRequests, generate_client_id
...
def func(dataFB, action="check", **kwargs):
     """
     Args:
          dataFB: dict trả về từ fbchat_v2.dataGetHome(setCookies)
...
* Ví dụ:
     ...
     createNotes.checkNote(dataFB)
     createNotes.createNote(dataFB, "Hello world", privacy="FRIENDS")
     createNotes.deleteNote(dataFB, "<note_id>")
     createNotes.recreateNote(dataFB, "<old_note_id>", "New note text")
