...
from fbchat_v2._messaging._editMessage import APP_ID, _build_ls_context, _error_response, _json, _publish_ls_requests
...
* Dữ liệu yêu cầu (args):
     ...
     - dataFB: lấy từ fbchat_v2.dataGetHome(setCookies)
...
* Ví dụ:
     ...
     from fbchat_v2 import dataGetHome, changeTheme

     dataFB = dataGetHome("<cookie Facebook>")
     print(changeTheme.listThemes(dataFB))
     print(changeTheme.changeTheme(dataFB, "123456789", "love"))
     print(changeTheme.func(dataFB, "123456789", "default"))
