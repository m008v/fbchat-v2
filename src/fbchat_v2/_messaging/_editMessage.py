...
from fbchat_v2._core._utils import generate_session_id, generate_client_id, gen_threading_id, json_minimal
...
* Ví dụ:
     ...
     from fbchat_v2 import dataGetHome, editMessage

     dataFB = dataGetHome("<cookie Facebook>")
     print(editMessage.editMessage(dataFB, "mid.$...", "Nội dung đã sửa"))
